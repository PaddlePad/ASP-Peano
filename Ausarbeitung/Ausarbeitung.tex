...
So w\"urde sich der Algorithmus in einem alternativen L\"osungsansatz noch zus\"atzlich mit Hilfe von SIMD-Instruktionen optimieren lassen.  
...
Hinzu kommt die M\"oglichkeit, den hier beschriebenen Algorithmus mit den im Kaptitel \textit{L\"osungsansatz} beschriebenen Alternativen weiter zu optimieren.
